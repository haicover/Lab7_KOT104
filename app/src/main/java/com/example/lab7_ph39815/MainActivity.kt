...
import com.example.lab7_ph39815.ui.model.Movie
import com.example.lab7_ph39815.ui.model.MovieViewModel
import com.example.lab7_ph39815.ui.screens.Screen1
import com.example.lab7_ph39815.ui.screens.ScreenNavigation
    ...
    )
    {
        Column(
            ...
            Column(modifier = Modifier.padding(8.dp)) {
                ...
                BoldValueText(label = "Thoi luong: ", value = movie.duration)
                BoldValueText(label = "Khoi chieu: ", value = movie.releaseDate)
            }
        }
    }
}
    ...
    Card(
        ...
        Row(
            ...
            AsyncImage(
                ...
                contentDescription = null,
                contentScale = ContentScale.FillWidth,
                modifier = Modifier.width(100.dp)  // Fixed width for the image
                    .height(200.dp)
                    .wrapContentHeight()
                    .fillMaxWidth()
            ...
            Column(modifier = Modifier.padding(8.dp)) {
                ...
                BoldValueText(label = "Thoi luong: ", value = movie.duration)
                BoldValueText(label = "Khoi chieu:", value = movie.releaseDate)
                BoldValueText(label = "The loai:", value = movie.genre)
                Text(
                    text = "Tom tat noi dung",
